...
class CrysGen:
    def __init__(self, dbname, template, metals, halogens,conc=1, num_gen=0, struct_per_gen=5, mixing_metals=True, mixing_halogens=True):
        """
    ...
    def F11(self):
        ...
        lattice constant,.
        """
        f11 = read('/home/charles/phd_project/task1/All_Structure/LiInF.cif')
        if self.template == 'F11':
            if self.mixing_halogens and self.mixing_metals:
                ...
                b_eq = [1, 1, 4*(2+C1), 4*C1, 4*(1-C1), (20-(4*(2+C1))-(4*C1)-(4*(1-C1)))]
                ...
                ns = NewStructures(settings=setting, generation_number=self.num_gen, struct_per_gen=self.struct_per_gen);
    ...
    def Cl12(self):
        ...
        lattice constant,.
        """
        cl12 = read('/home/charles/phd_project/task1/All_Structure/LiScCl.cif')
        if self.template == 'Cl12':
            if self.mixing_halogens and self.mixing_metals:
                ...
                b_eq = [1, 1, 2*(2+C1), 2*(1-C1), 2*C1, (12-(2*(2+C1))-(2*(1-C1))-(2*C1))]
    ...
    def Br12(self):
        ...
        lattice constant,.
        """
        br12 = read('/home/charles/phd_project/task1/All_Structure/LiErBr.cif')
        if self.template == 'Br12':
            if self.mixing_halogens and self.mixing_metals:
                ...
                b_eq = [1, 1, 2*(2+C1), 2*(1-C1), 2*C1, (10-(2*(2+C1))-(2*(1-C1))-(2*C1))]
    ...
    def F15(self):
        ...
        lattice constant,.
        """
        f15 = read('/home/charles/phd_project/task1/All_Structure/LiGaF.cif')
        if self.template == 'F15':
            if self.mixing_halogens and self.mixing_metals:
                ...
                basis_elements=[['Li', M1, M2, 'X'], ['Li', M1, M2, 'X'], ['Li', M1, M2, 'X'], ['Li', M1, M2, 'X'], ['Li', M1, M2, 'X'], #36
                                ['Li', M1, M2, 'X'],['Li', M1, M2, 'X'], #12
                ...
                b_eq = [1, 1, 12*(2+C1), 12*(1-C1), 12*C1, (48-(12*(2+C1))-(12*(1-C1))-(12*C1))]
    ...
    def Cl62(self):
        ...
        lattice constant,.
        """
        cl62 = read('/home/charles/phd_project/task1/All_Structure/LiYbCl.cif')
        if self.template == 'Cl62':
            if self.mixing_halogens and self.mixing_metals:
                ...
                basis_elements=[['Li', M1, M2, 'X'], #5.64  --> 8
                                ['Li', M1, M2, 'X'], #6.36  --> 8
                                ['Li', M1, M2, 'X'], #4 --> 4
                                [X1, X2], [X1, X2], [X1, X2], [X1, X2]] #24 --> 24
                ...
                b_eq = [1, 1, 4*(2+C1), 4*(1-C1), 4*C1, (20-(4*(2+C1))-(4*(1-C1))-(4*C1))]
    ...
    def Cl164(self):
        ...
        lattice constant,.
        """
        cl164 = read('/home/charles/phd_project/task1/All_Structure/LiErCl.cif')
        if self.template == 'Cl164':
            if self.mixing_halogens and self.mixing_metals:
                ...
                b_eq = [1, 1, 3*(2+C1), 3*(1-C1), 3*C1, (17-(3*(2+C1))-(3*(1-C1))-(3*C1))]
    ...
    def F165(self):
        ...
        lattice constant,.
        """
        f165 = read('/home/charles/phd_project/task1/All_Structure/LiScF.cif')
        if self.template == 'F165':
            if self.mixing_halogens and self.mixing_metals:
                ...
                basis_elements=[['Li', M1, M2, 'X'], ['Li', M1, M2, 'X'], #18  --> 18
                                ['Li', M1, M2, 'X'], #6 --> 6
                                ['Li', M1, M2, 'X'],
                ...
                b_eq = [1, 1, 6*(2+C1), 6*(1-C1), 6*C1, (24-(6*(2+C1))-(6*(1-C1))-(6*C1))]
